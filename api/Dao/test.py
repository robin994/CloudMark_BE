...
from api.Model.UserModel import SessionModel, UserModel
...
class test:
  def main():
    ...
    userUpdate = AccountModel(id_account=2, user="Beppe1234", abilitato='1')
    # logging.warning(AccountDao.updateAccountByID(accountUpdate))
    # logging.warning(AccountDao.deleteAccountByID(2))
    logging.warning(AccountDao.updateAccount(userUpdate))
